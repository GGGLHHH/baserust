...
This project is indexed by GitNexus as **baserust** (1306 symbols, 2798 relationships, 110 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
